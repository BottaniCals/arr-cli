...
- [x] 2. Rewrite 14 per-service `columns = [...]` blocks to summary-shape keys
  - [x] 2.1 Rewrite `arr_cli/jellyfin.py` columns blocks (5 commands)
  ...
  - [x] 2.2 Rewrite `arr_cli/radarr.py` columns blocks (3 commands)
  ...
  - [x] 2.3 Rewrite `arr_cli/sonarr.py` columns blocks (3 commands)
  ...
  - [x] 2.4 Rewrite `arr_cli/seerr.py` columns blocks (3 commands)
  ...
  - [x] 2.5 Verify `arr_cli/maintainerr.py` is untouched
